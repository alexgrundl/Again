...
public:
    ...
    LinkDelaySyncIntervalSetting(TimeAwareSystem* timeAwareSystem, PortGlobal* port, INetworkInterfacePort* networkPort);


    ~LinkDelaySyncIntervalSetting();


    void SetSignalingMessage(IReceivePackage *package);
